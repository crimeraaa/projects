...
// Mark constructors as when separating into different translation units.
// https://stackoverflow.com/a/14953411
class Tetris {
...
private: // MEMBER VARIABLES
    Display m_display; // @note 1st in initializer list
    PlayingField m_pfield; // @note 2nd in initializer list
    Player m_player; // @note 3rd in initializer list
...
public: // METHODS
    ...
    // Updates the player's position and rotation as well.
    void input();
...
private: // INPUT HELPERS
    /**
     * @brief Get the correct 1D index into a piece based on its rotation.
     * 
