...
class __PrettyPrinter(gdb.printing.PrettyPrinter):
    ...
    def __init__(self, name: str):
        ...
        self.__printers = {
            # Structs
            "lulu::[opcode.odin]::Instruction": opcode.InstructionPrinter,
            "lulu::[lexer.odin]::Token":        lexer.TokenPrinter,
            "lulu::[expr.odin]::Expr":          expr.ExprPrinter,
            "lulu::[value.odin]::Value":        value.Value_Printer,
            "lulu::[ostring.odin]::Ostring":    value.Ostring_Printer,
            "lulu::[object.odin]::Object":      value.Object_Printer,
            ...
            "lulu::[expr.odin]::Expr *":        expr.ExprPrinter,
            "lulu::[object.odin]::Object *":    value.Object_Printer,
            "lulu::[object.odin]::Object_List *": value.Object_List_Printer,
            "lulu::[object.odin]::GC_List *":   value.GC_List_Printer,
            "lulu::[ostring.odin]::Ostring *":  value.Ostring_Printer,
        }
